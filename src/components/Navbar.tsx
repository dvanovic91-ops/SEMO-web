        ...
        >
          ...
          <div className="hidden flex-1 items-center justify-end gap-0.5 md:flex">
            ...
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200/90 bg-white text-[#0088cc] transition hover:border-[#0088cc]/50 hover:bg-sky-50"
              aria-label="Telegram"
            >
